    ...
    "Statement" : [
      {
        ...
        "Resource" : [
          "arn:aws:ssm:us-east-1:460304078594:parameter/${var.env}.${var.component}*",
          "arn:aws:ssm:us-east-1:460304078594:parameter/nexus*",
          "arn:aws:ssm:us-east-1:460304078594:parameter/${var.env}.docdb*",
          ...
          "arn:aws:ssm:us-east-1:460304078594:parameter/grafana*",
          "arn:aws:ssm:us-east-1:460304078594:parameter/${var.env}.ssh*"
